...
def login():
    ...
    old_driver.find_element_by_xpath(
        '//*[@id="web-content"]/div/div/div/div[2]/div/div[2]/div[2]/div[2]/div[2]/input').send_keys("13996612955")
    old_driver.find_element_by_xpath(
        '//*[@id="web-content"]/div/div/div/div[2]/div/div[2]/div[2]/div[2]/div[3]/input').send_keys("abc123456")
    time.sleep(0.3)
    old_driver.find_element_by_xpath(
